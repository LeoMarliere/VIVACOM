...
public class ConstantLatLng {

    // -------------- LatLng ----------------

    // Ville
    public static final LatLng latlng_LILLE = new LatLng(50.63835706647613, 3.0628037452697754);
    ...
    //public static final LatLng latlng_euraLille = new LatLng(50.637458881326104, 3.0745410919189453);
    //public static final LatLng latlng_gareLilleEurope = new LatLng(50.639472969570065, 3.0754926055669785);
    //public static final LatLng latlng_gareLilleFlandre = new LatLng(50.63634293041071, 3.070557340979576);
    ...
    // ------- Points Culture -------
    // GrandPlace
    public static final LatLng latlng_pyramide = new LatLng(50.635539973727376, 3.062911033630371);

    // LilleCentre
    public static final LatLng LATLNG_STATUEFOCH = new LatLng(50.635934649065504, 3.056623935699463);
    public static final LatLng LATLNG_LITTLEHAVANA = new LatLng(50.63745207682765, 3.0582332611083984);
    public static final LatLng LATLNG_LE28 = new LatLng(50.63802195016053, 3.058898448944092);
    public static final LatLng LATLNG_QUAIDUWAULT = new LatLng(50.6370131845957, 3.054648949764669);
    public static final LatLng LATLNG_HUITRIERE = new LatLng(50.63948657798084, 3.06390437297523);

    // Theatre
    public static final LatLng LATLNG_COMMERCE = new LatLng(50.63777188719061, 3.064337968826294);

    // VieuxLille
    public static final LatLng LATLNG_MEERT = new LatLng(50.637731060456915, 3.061859607696533);
    public static final LatLng LATLNG_KREMLIN = new LatLng(50.63998328227791, 3.0594536662101746);
    public static final LatLng LATLNG_COURSINTERIEURE = new LatLng(50.63871429443525, 3.0631005903705955);
    public static final LatLng LATLNG_RUEWEPPES = new LatLng(50.639408329565015, 3.0604979675263166);


    // ------- Point Secret -------
    public static final LatLng LATLNG_GOLDENARM = new LatLng(50.63818100312599, 3.063800416421145);
    public static final LatLng LATLNG_FRANCMACON = new LatLng(50.63851526776442, 3.059301241301);
    ...
    public static final CameraPosition CAMPOS_GRANDPLACE = new CameraPosition.Builder().target(LATLNG_GRANDPLACE).zoom(17.8f).bearing(0).tilt(30).build();
